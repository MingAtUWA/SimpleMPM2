...
{
	TimeHistoryOutput_S2D_CHM_s &th = static_cast<TimeHistoryOutput_S2D_CHM_s &>(_self);
	Model_S2D_CHM_s &model = static_cast<Model_S2D_CHM_s &>(th.get_model());
	Step_S2D_CHM_s &step = static_cast<Step_S2D_CHM_s &>(th.get_step());
