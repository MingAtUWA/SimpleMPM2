...
Step_T2D_ME_s_Geostatic::Step_T2D_ME_s_Geostatic() :
	Step(&solve_substep_T2D_ME_s_Geostatic), model(nullptr) {}

Step_T2D_ME_s_Geostatic::~Step_T2D_ME_s_Geostatic() {}

int Step_T2D_ME_s_Geostatic::init_calculation(void)
{
...
{
	Step_T2D_ME_s_Geostatic &self = *(Step_T2D_ME_s_Geostatic *)(_self);
