...
int Step_S2D_ME_s_RigidBody::init_calculation()
{
	if (is_first_step)
	{
...
int Step_S2D_ME_s_RigidBody::finalize_calculation() { return 0; }

int solve_substep_S2D_ME_s_RigidBody(void *_self)
{
	Step_S2D_ME_s_RigidBody &self = *((Step_S2D_ME_s_RigidBody *)_self);
