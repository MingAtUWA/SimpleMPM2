...
Step_S2D_ME_s_Geostatic::Step_S2D_ME_s_Geostatic() :
	Step(&solve_substep_S2D_ME_s_Geostatic) {}

Step_S2D_ME_s_Geostatic::~Step_S2D_ME_s_Geostatic() {}

int Step_S2D_ME_s_Geostatic::init_calculation(void)
{
...
int Step_S2D_ME_s_Geostatic::finalize_calculation(void)
{
	Model_S2D_ME_s &md = *static_cast<Model_S2D_ME_s *>(model);
