#ifndef __GA_T2D_ME_s_color_H__
#define __GA_T2D_ME_s_color_H__
...
class GA_T2D_ME_s_color : public GenerateAnimation
{
protected:
	...
	double *mp_s11_data, *mp_s22_data, *mp_s12_data;
...
public:
	GA_T2D_ME_s_color(GLsizei win_w = 600, GLsizei win_h = 600);
	~GA_T2D_ME_s_color();
