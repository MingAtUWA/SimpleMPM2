...
{
	TimeHistoryOutput_S2D_CHM_s_uUp &th = static_cast<TimeHistoryOutput_S2D_CHM_s_uUp &>(_self);
	Model_S2D_CHM_s_uUp &model = static_cast<Model_S2D_CHM_s_uUp &>(th.get_model());
	Step_S2D_CHM_s_uUp &step = static_cast<Step_S2D_CHM_s_uUp &>(th.get_step());
