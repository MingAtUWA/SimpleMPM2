...
void test_t2d_mpm_chm_s_t_bar_real(void)
{
	...
	res_file_hdf5.create("t2d_mpm_chm_t_bar_real.hdf5");
...
void test_t2d_mpm_chm_s_t_bar_restart_from_geostatic(void)
{
	Model_T2D_CHM_s model;

	load_chm_s_model_from_hdf5_file(
		model,
		"t2d_mpm_chm_t_bar_real.hdf5",
		"th2",
		100
	);
