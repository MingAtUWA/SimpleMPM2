...
int Step_T2D_CHM_s_SE_Geostatic::init_calculation(void)
{
...
int Step_T2D_CHM_s_SE_Geostatic::finalize_calculation(void)
{
	Model_T2D_CHM_s &md = *model;
...
{
	Step_T2D_CHM_s_SE_Geostatic &self = *(Step_T2D_CHM_s_SE_Geostatic *)(_self);
	...
	for (size_t e_id = 0; e_id < md.elem_num; ++e_id)
	{
		...
		if (e.pcls && e.vol != 0.0)
		{
			...
			// node 1
			n1.fx_int_s += (e.dN1_dx * e.s11 + e.dN1_dy * e.s12) * e.vol;
			n1.fy_int_s += (e.dN1_dx * e.s12 + e.dN1_dy * e.s22) * e.vol;
			// node 2
			n2.fx_int_s += (e.dN2_dx * e.s11 + e.dN2_dy * e.s12) * e.vol;
			n2.fy_int_s += (e.dN2_dx * e.s12 + e.dN2_dy * e.s22) * e.vol;
			// node 3
			n3.fx_int_s += (e.dN3_dx * e.s11 + e.dN3_dy * e.s12) * e.vol;
			n3.fy_int_s += (e.dN3_dx * e.s12 + e.dN3_dy * e.s22) * e.vol;
		}
	}
