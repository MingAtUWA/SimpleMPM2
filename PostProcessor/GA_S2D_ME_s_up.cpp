...
GA_S2D_ME_s_up::GA_S2D_ME_s_up() : mp_x_data(nullptr) {}
GA_S2D_ME_s_up::~GA_S2D_ME_s_up()
{
	if (mp_x_data)
	{
		delete[] mp_x_data;
...
int GA_S2D_ME_s_up::init(const char *res_file_name)
{
...
int GA_S2D_ME_s_up::render_frame(double xl, double xu, double yl, double yu)
{
