...
GA_S2D_CHM_s_uUp::GA_S2D_CHM_s_uUp() : mp_x_data(nullptr) {}

GA_S2D_CHM_s_uUp::~GA_S2D_CHM_s_uUp()
{
	if (mp_x_data)
	{
		delete[] mp_x_data;
...
int GA_S2D_CHM_s_uUp::init(const char *res_file_name)
{
	...
	time_rcd_len = sizeof(TimeHistoryHeader) + sizeof(MPObjectHeader) + mph.pcl_num * 7 * sizeof(double);
...
int GA_S2D_CHM_s_uUp::render_frame(double xl, double xu, double yl, double yu)
{
