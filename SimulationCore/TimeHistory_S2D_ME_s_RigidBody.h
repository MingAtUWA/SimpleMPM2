#ifndef __TIME_HISTORY_S2D_ME_S_RIGIDBODY_H__
#define __TIME_HISTORY_S2D_ME_S_RIGIDBODY_H__
...
{
public:
	TimeHistory_S2D_ME_s_RigidBody() : TimeHistory("S2D_ME_RigidBody") {}
	...
	{
		res_file = &_res_file;
		output_func = *const_cast<OutputFunc *>(&_res_file.out_func_th_MPM_RigidBody_PlainBin);
	}

	inline void set_res_file(ResultFile_XML &_res_file) noexcept
	{
		res_file = &_res_file;
		output_func = *const_cast<OutputFunc *>(&_res_file.out_func_th_MPM_RigidBody_XML);
	}
};
