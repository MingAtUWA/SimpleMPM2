...
{
	TimeHistoryOutput_S2D_ME_s_up &th = static_cast<TimeHistoryOutput_S2D_ME_s_up &>(_self);
	Model_S2D_ME_s_up &model = static_cast<Model_S2D_ME_s_up &>(th.get_model());
	Step_S2D_ME_s_up &step = static_cast<Step_S2D_ME_s_up &>(th.get_step());
