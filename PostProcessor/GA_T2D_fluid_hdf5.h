#ifndef __GA_T2D_fluid_hdf5_H__
#define __GA_T2D_fluid_hdf5_H__
...
class GA_T2D_fluid_hdf5 : public GenerateAnimation
{
protected:
	...
	// particle data
	MemoryUtilities::ItemArrayFast<Model_T2D_fluid_hdf5_io_utilities::ParticleData> pcls_data;
...
public:
	GA_T2D_fluid_hdf5(GLsizei win_w = 600, GLsizei win_h = 600);
	~GA_T2D_fluid_hdf5();
