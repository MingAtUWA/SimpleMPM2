#ifndef __Time_History_Output_T2D_ME_s_H__
#define __Time_History_Output_T2D_ME_s_H__
...
{
public:
	TimeHistoryOutput_T2D_ME_s() : TimeHistoryOutput("T2D_ME_s") {}
	...
	{
		res_file = &_res_file;
		output_func = &time_history_output_func_t2d_me_s_to_plain_bin_res_file;
	}

	friend int time_history_output_func_t2d_me_s_to_xml_res_file(TimeHistoryOutput &_self);
