...
int TimeHistoryOutput_S2D_ME_s::init(void)
{
	if (is_init)
		return 0;
	is_init = true;
...
int TimeHistoryOutput_S2D_ME_s::close(void)
{
	switch (res_file->get_type())
	{
	case ResultFileType::PlainBin:
...
{
	TimeHistoryOutput_S2D_ME_s &th
		= static_cast<TimeHistoryOutput_S2D_ME_s &>(_self);
