...
using namespace Model_T2D_ME_s_hdf5_io_utilities;

GA_T2D_ME_s_hdf5::GA_T2D_ME_s_hdf5(GLsizei win_w, GLsizei win_h) :
	GenerateAnimation(win_w, win_h), th_id(-1),
	cbar_pt_data(nullptr), cbar_id_data(nullptr), cbar_is_init(false) {}

GA_T2D_ME_s_hdf5::~GA_T2D_ME_s_hdf5()
{
	if (cbar_pt_data)
	{
		delete[] cbar_pt_data;
...
int GA_T2D_ME_s_hdf5::_init(const char *file_name, const char *th_name)
{
...
int GA_T2D_ME_s_hdf5::init_color_graph(
...
int GA_T2D_ME_s_hdf5::render_frame(double xl, double xu, double yl, double yu)
{
...
int GA_T2D_ME_s_hdf5::generate(double ani_time, double xl, double xu, double yl, double yu,
